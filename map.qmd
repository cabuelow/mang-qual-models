...
dat <- read.csv('outputs/master-dat.csv') %>% filter(pressure_def == 3)
...
Same as above for **Future drought**, except mangrove typological units with greater than 50th percentile increase in SPI values were considered at risk from extreme rainfall.
:::
