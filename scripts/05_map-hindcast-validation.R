...
naive_outcomes <- read.csv(paste0('outputs/validation/naive_outcomes_', go, '.csv'))
results <- readRDS(paste0('outputs/validation/accuracy_', go, '.RDS'))
...
lmap
tmap_save(lmap, paste0('outputs/maps/landward-hindcast_map_match_', go, '.png'), width = 5, height = 1)
...
smap <- tm_shape(world_mang) +
  ...
  tm_add_legend('symbol', col =  c('red','black', 'lightgoldenrod', 'palegreen4'), 
                labels =  c('No Prediction', 'MisMatch', 'Ambiguous', 'Match'), border.alpha = 0, size = 0.3)
smap
tmap_save(smap, paste0('outputs/maps/seaward-hindcast_map_match_', go, '.png'), width = 5, height = 1)
...
lmap
tmap_save(lmap, paste0('outputs/maps/landward-hindcast_map_', go, '.png'), width = 5, height = 1)
...
smap <- tm_shape(world_mang) +
  ...
  tm_add_legend('symbol', col =  c('firebrick4', 'lightgoldenrod', 'deepskyblue4'), 
                labels =  c('Loss','Ambiguous', 'Gain/Neutrality'), border.alpha = 0, size = 0.3)
smap
tmap_save(smap, paste0('outputs/maps/seaward-hindcast_map_', go, '.png'), width = 5, height = 1)
...
post_prob <- post_prob[,c('csqueeze', 'sed_supp', 'Tidal_Class', 'prop_estab', 'vals_gwsub', 'vals_hist_drought',
...
# reorder column names so always in same order regardless of filtering
final_preds <- final_preds[,c('csqueeze', 'sed_supp', 'Tidal_Class', 'prop_estab', 'vals_gwsub', 'vals_hist_drought',
                    'vals_hist_ext_rain', 'vals_storms', 'vals_ant_slr', 'vals_csqueeze_1', 'press_gwsub',
                    'press_hist_drought', 'press_hist_ext_rain', 'press_storms', 'press_ant_slr',
                    'press_csqueeze_1', 'csqueeze_2', 'sed_supp_2', 'Tidal_Class_2', 'prop_estab_2')]
...
lmap <- tm_shape(world_mang) +
  ...
  tm_add_legend('symbol', col =  c('firebrick4', 'lightgoldenrod', 'deepskyblue4'), 
                labels =  c('Loss','Ambiguous', 'Gain/Neutrality'), border.alpha = 0, size = 0.3)
lmap
tmap_save(lmap, paste0('outputs/maps/landward-hindcast_map_', go, '_all-data.png'), width = 5, height = 2)
...
smap <- tm_shape(world_mang) +
  ...
  tm_add_legend('symbol', col =  c('firebrick4', 'lightgoldenrod', 'deepskyblue4'), 
                labels =  c('Loss','Ambiguous', 'Gain/Neutrality'), border.alpha = 0, size = 0.3)
smap
tmap_save(smap, paste0('outputs/maps/seaward-hindcast_map_', go, '_all-data.png'), width = 5, height = 2)