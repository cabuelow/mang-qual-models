...
saveRDS(tmp, paste0('outputs/simulation-outcomes/scenario_matrices_', go, '.RDS'))
...
write.csv(naive_outcomes, paste0('outputs/validation/naive_outcomes_', go, '.csv'), row.names = F)
...
shuffled_dat <- shuffled_dat[,c('pressure_def', 'k', 'Type', 'csqueeze', 'sed_supp', 'Tidal_Class', 'prop_estab', 'land_net_change_obs', 'sea_net_change_obs',
              'vals_gwsub', 'vals_hist_drought', 'vals_hist_ext_rain', 'vals_storms', 'vals_ant_slr', 'vals_csqueeze_1', 'press_gwsub',
              'press_hist_drought', 'press_hist_ext_rain', 'press_storms', 'press_ant_slr',
              'press_csqueeze_1', 'csqueeze_2', 'sed_supp_2', 'Tidal_Class_2', 'prop_estab_2')]
...
stopCluster(cl)
saveRDS(results, paste0('outputs/validation/accuracy_', go, '.RDS'))
...
ggsave(paste0('outputs/validation/accuracy-heatmap_kfold_', go, '.png'), width = 15, height = 11)
...
ggsave(paste0('outputs/validation/accuracy-heatmap_kfold_averaged_', go, '.png'), width = 10, height = 4.5)
