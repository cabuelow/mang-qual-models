...
# to obtain sampling distribution of each accuracy estimate (overall, producers, users)
...
# by taking the 95th percentiles of the commission and omission errors for each class
...
# num_gain_units(lower) = num_gain_units - (num_gain_units * comission_error(95 percentile)) # commission error is the rate of false positives, so predictions of a class we shouldn't have, so is the lower