...
forecasts <- read.csv(paste0('outputs/predictions/forecast-predictions', go, '_', rm_e, '_', press, '_', thresh, '_', scenario, '_fit.csv'))
...
mapview(preds_hind, zcol = 'sea_net_change', layer.name = 'Seaward extent change', cex = 0.9, lwd = 0, map.type = 'Esri.WorldGrayCanvas') | mapview(preds_hind, zcol = 'land_net_change', layer.name = 'Landward extent change', cex = 0.9, lwd = 0, map.type = 'Esri.WorldGrayCanvas')
...
mapview(preds_hind, zcol = 'Seaward_match', layer.name = 'Seaward', cex = 0.9, lwd = 0, map.type = 'Esri.WorldGrayCanvas') | mapview(preds_hind, zcol = 'Landward_match', layer.name = 'Landward', cex = 0.9, lwd = 0, map.type = 'Esri.WorldGrayCanvas')
```
:::
...
mapview(filter(preds_fore, !is.na(Seaward)), zcol = 'Seaward', layer.name = 'Seaward', cex = 0.9, lwd = 0, map.type = 'Esri.WorldGrayCanvas') | mapview(filter(preds_fore, !is.na(Landward)), zcol = 'Landward', layer.name = 'Landward', cex = 0.9, lwd = 0, map.type = 'Esri.WorldGrayCanvas')
```
:::
...
Scenario-based forecasts of landward gain/neutrality with management or restoration are mapped in the left pane, seaward on the right.

```{r echo=FALSE, message=FALSE, warning=FALSE, results=TRUE}

 mapview(filter(scenario_change, !is.na(Landward_scenario_gain)), zcol = 'Landward_scenario_gain', layer.name = 'Landward', cex = 0.9, lwd = 0, map.type = 'Esri.WorldGrayCanvas') | mapview(filter(scenario_change, !is.na(Seaward_scenario_gain)), zcol = 'Seaward_scenario_gain', layer.name = 'Seaward', cex = 0.9, lwd = 0, map.type = 'Esri.WorldGrayCanvas')
```
:::
...
Scenario-based forecasts of landward reduced certainty of loss with management or restoration are mapped in the left pane, seaward on the right.
