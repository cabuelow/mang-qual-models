...
```
Hindcasts of **landward extent change** have an overall classification accuracy of `r round(calc_accuracy_multi(land$Land_Change, land$land_change_c))$accuracy`%.

The percentage of **landward gain** hindcast predictions that are correct is `r round(calc_accuracy_multi(land$Land_Change, land$land_change_c))$precision_gain`%.

The percentage of **landward loss** hindcast predictions that are correct is `r round(calc_accuracy_multi(land$Land_Change, land$land_change_c))$precision_loss`%.

The percentage of **landward gain or loss** hindcast predictions that are correct is `r round(calc_accuracy_multi(land$Land_Change, land$land_change_c))$precision_loss_gain`%.
:::
...
```
Hindcasts of **seaward extent change** have an overall classification accuracy of `r round(calc_accuracy_multi(sea$Sea_Change, sea$sea_change_c))$accuracy`%.

The percentage of **seaward loss** hindcast predictions that are correct is `r round(calc_accuracy_multi(sea$Sea_Change, sea$sea_change_c))$precision_loss`%.

The percentage of **seaward gain or loss** hindcast predictions that are correct is `r round(calc_accuracy_multi(sea$Sea_Change, sea$sea_change_c))$precision_loss_gain`%.
:::
