...
Only **subsidence**, **sediment supply**, **future dams**, **historical observations of landward and seaward mangrove extent change**, and **hindcasts and forecasts of landward and seaward extent change** are found on this page.
...
::: {.callout-tip icon="false" collapse="true"}
### Hindcasts matches and mis-matches {#landhind-forecast}
...
Scenario-based forecasts of seaward gain/neutrality with management or restoration change are mapped in the left pane, landward on the right.
...
Scenario-based forecasts of seaward reduced certainty of loss with management or restoration change are mapped in the left pane, landward on the right.
