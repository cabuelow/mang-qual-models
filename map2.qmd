...
preds_hind <- st_read('data/typologies/Mangrove_Typology_v3_Composite_valid_centroids.gpkg') %>% # join hindcasts to spatial data
...
preds_fore <- st_read('data/typologies/Mangrove_Typology_v3_Composite_valid_centroids.gpkg') %>% 
  left_join(forecasts)
...
::: {.callout-tip icon="false" collapse="true"}
### Scenario-based forecasts of mangrove gain/neutrality or reduced certainty of loss with management or restoration
